...
export class MovieserviceService {
  ...
  public getTopRatedMovie(pageNo){
  ...
  public getUpcomingMovie(pageNo){
    this.final_url = this.REST_API_SERVER + "upcoming?api_key="+this.REST_API_KEY+this.REST_API_SERVER_TAIL+pageNo;
    return this.httpClient.get(this.final_url).pipe(retry(3), catchError(this.handleError));
  }

  public getPopularMovie(pageNo){
