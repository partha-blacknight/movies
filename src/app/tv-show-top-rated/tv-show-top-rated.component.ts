...
@Component({
  selector: 'app-tv-show-top-rated',
  templateUrl: './tv-show-top-rated.component.html',
  styleUrls: ['./tv-show-top-rated.component.scss']
})
export class TvShowTopRatedComponent implements OnInit {
